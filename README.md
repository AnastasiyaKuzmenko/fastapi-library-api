...
```
## 📘 Документация API
После запуска сервера доступна интерактивная документация Swagger по адресу:
`http://127.0.0.1:8000/docs`
Это позволяет вручную вызывать эндпоинты, передавать параметры и токены, а также просматривать схему API. 
